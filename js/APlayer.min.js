...
function getStyle() {
  let sss = setInterval(() => {
    var myDiv = document.querySelector("#eoMusic-page .aplayer-lrc-contents p"); 
    // 先确保结构加载完
    if (myDiv) {
      // 判断是否是IE浏览器（不适配IE浏览器）
